...
> Note: the 2026-08-31-later + 2026-09-07 entries (#11 implementation, PR #87, live walk-through,
> review checklist) live on `feature/domain-model-mapping`'s memory.md — merge will reconcile.
